...
function About() {
  return (
    <div className="p-6 bg-white shadow-md w-full">
      ...
      <p className="mb-4">
        The advent of more advanced computing and communication technologies is finding its way into our day-to-day application areas like smart home and automation, automotive, healthcare, logistics, finance, and other smart city applications. The emerging fifth-generation communication systems foster new technical insights for the Information Technology industry to drive transformation towards next-generation communication. To promote research progress in these advanced intelligent computing and communication technologies, the International Conference on Intelligent Systems & Computing (ICNCDA 2026) on September 10-11, 2026, organized by PIET Jaipur, India, serves as an innovative forum to share and exchange innovative research ideas related to advanced intelligent computing and communication technologies.
      </p>
    </div>
  );
};
