      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-xl">
        ...
        <div className="overflow-x-auto mb-12">
          <table className="min-w-full table-auto text-center border-collapse border border-gray-200">
            ...
            <tbody>
              {[
                ["Faculty Non-Member (International Professional Membership)", "INR 8,000", "INR 9,000"],
                ["Faculty Member (International Professional Membership)", "INR 7,000", "INR 8,000"],
                ["Faculty Non-Member (International Professional Membership) with International co-Author", "INR 6,000", "INR 7,000"],
                ["Faculty (International Professional Membership) With International co-Author", "INR 6,000", "INR 7,000"],
                ["International Author Non-Member (International Professional Membership)", "$85", "$200"],
                ["Faculty International Author and Member (International Professional Membership)", "$75", "$90"],
                ["Corporate/Industry Professional", "INR 8,000", "INR 9,000"],
                ["Ph.D Student", "INR 6,000", "INR 7,000"],
                ["PG/UG Student", "INR 4,500", "INR 5,500"],
