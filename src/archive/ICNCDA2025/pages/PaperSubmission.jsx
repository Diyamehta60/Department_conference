  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 mt-12">
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-600">
            ICNCDA-2025 offered an international platform for researchers to present their work in
        ...
        <section className="mb-12">
          ...
          <p className='text-gray-600 mb-4'>All submissions were submitted through the CMT using the link : <span className='font-bold'>https://cmt3.research.microsoft.com/ICNCDA2025</span></p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="flex items-center mt-4">
            ...
            <span className="text-lg text-gray-600">
              Submission Deadline: <strong>Closed</strong>
            </span>
          </div>
        </section>
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-lg text-gray-600 mb-6">
            This archived page preserves the ICNCDA-2025 submission information. Click below to view the
            submission process!
          </p>
          <a
      ...
      <div className="text-center mt-16 pt-12 border-t border-gray-200">
        ...
        <p className="text-lg text-gray-600 mb-6">
          Reviewer information for ICNCDA-2025 is preserved here for archive reference.
          field!
        </p>
        <a
