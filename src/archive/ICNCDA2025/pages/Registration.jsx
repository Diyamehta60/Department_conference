      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-xl">
        ...
        <div className="text-center mb-12">
          <p className="text-lg text-gray-600 mb-6">
            Registration information for the International Conference on Networked Computing and Data Analytics (ICNCDA-2025) is preserved here for archive reference.
          </p>
        </div>
    ...
    <div className="flex justify-start items-center ">
      ...
      <span className="text-gray-600">HDFCINBBXXX</span>
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-lg text-gray-600 mb-6">
            ICNCDA-2025 registration has been completed. This archived page preserves the registration details for reference.
          </p>
          <a
